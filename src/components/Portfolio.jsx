...
const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-auto pt-20 px-2 sm:px-3"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col justify-center w-full h-full pb-24">
        <div className="pb-8">
